...
const float TURN_SLOWDOWN_DEG = 15.0;  // Start slowing down this many degrees before target
...
void loop() {
  ...
  if (elapsed < 5000) {
    ...
    if (!turned) {
      turned = true;
      turnToHeading(90.0, 120, 3.0, 3000);  // turn to 90°, PWM=120, ±3° tolerance, 3 s timeout
    }
  } else {
    stopAll();
  }
